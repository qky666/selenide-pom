...
class ToolsTabContentWidget(self: SelenideElement) : Widget(self) {
    ...
    @Required val home = ToolItem(
        find("div[class$=home]"),
        mapOf(
            "en" to Condition.exactText("home"),
            "es" to Condition.exactText("Inicio")
        ),
        mapOf(
    ...
    @Required val foldAll = ToolItem(
        ...
        mapOf(
            "en" to Condition.exactText("fold all tiddlers"),
            "es" to Condition.exactText("Comprimir todos")
        ),
        mapOf(
    ...
    @Required val unfoldAll = ToolItem(
        ...
        mapOf(
            "en" to Condition.exactText("unfold all tiddlers"),
            "es" to Condition.exactText("Desplegar todos")
        ),
        mapOf(
    ...
    @Required val permaview = ToolItem(
        ...
        mapOf(
            "en" to Condition.exactText("permaview"),
            "es" to Condition.exactText("Permaview")
        ),
        mapOf(
