...
@CucumberOptions(
    ...
    plugin = ["{{ cookiecutter.group }}.common_web.cucumber.listener.CucumberListener", "io.qameta.allure.cucumber7jvm.AllureCucumber7Jvm", "pretty", "json:build/test-results/cucumber/rerun.json", "rerun:build/test-results/cucumber/failed_scenarios.txt"],
    tags = "@retry",
)
